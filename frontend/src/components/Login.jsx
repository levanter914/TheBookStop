...
const Login = () => {
  ...
  return (
    <div className="flex items-center justify-center min-h-[auto] mb-4 rounded-lg bg-gray-100 dark:bg-transparent mt-2 md:mt-0">
      <div className="w-full max-w-md p-4 rounded-md shadow-2xl sm:p-8 dark:bg-transparent dark:text-gray-800 items-center">
        ...
        <p className="text-sm text-center dark:text-gray-600">
          ...
          <Link
            ...
            className="focus:underline hover:underline dark:text-secondary"
          >
            Sign up here
          </Link>
        </p>
